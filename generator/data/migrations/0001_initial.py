...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # migrations.RunSQL(
        #     """
        #     SELECT create_retention_policy('retention_policy_datasetgenerate', hypertable='DatasetGenerate', strategy='delete', window_interval='1 minutes');
        #     """,
        # ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            "SELECT create_hypertable('data_datasetgenerate', 'time_internal', chunk_time_interval => INTERVAL '5 minutes');"
            "SELECT add_retention_policy('data_datasetgenerate', drop_after => INTERVAL '7 minutes');"
        ),
    ]
